...
<head>
<title>PhotoProwess | Style Demo</title>
...
<div class="wrapper col2">
  <div id="header" class="clear">
    ...
    <div id="topnav">
      <ul>
        <li class="last"><a href="gallery.php">Gallery</a><span>Test Text Here</span></li>
        <li><a href="portfolio.php">Portfolio</a><span>Test Text Here</span></li>
        ...
        <li><a href="full-width.php">Full Width</a><span>Test Text Here</span></li>
        <li class="active"><a href="style-demo.php">Style Demo</a><span>Test Text Here</span></li>
        <li><a href="../index.php">Homepage</a><span>Test Text Here</span></li>
      </ul>
    </div>
  </div>
</div>
    ...
    <div id="content">
	 ...
	 <tr>
		...
		//if(isset($_GET['Prod_id']))
		 ...
		 $prod_id=0;
          $result=mysql_query("select * from tbl_product where Prod_id=$p_id ");
		 ...
		 $prod_id=$row['Prod_id'];
		  	$img=$rows['Image'];
				...
				$path='../admin/Image/'.$img;
		//    echo "<h1> Welcome\t\t\t\t\t\t\t\t\t".$rows['uname']."</h1>";
		   // echo $result;
		   //echo $path;	
		...
		?>
		<td width="70%">
       <img class="first"  height="500" width="400" src="<?php echo $path; ?>"/>
    <!--  <img class="imgr" src="<?php echo $path; ?>" alt="" width="125" height="125" /> -->
	</td>
	<td width="30%">
      <?php
	   echo "<li>Product Name:".$rows['Prod_name']."</li>";
	   echo "<li>Product Description:".$rows['Description']."</li>";
	    echo "<li>Price:".$rows['Price']."</li>";
		
	  }?>
	  </td>
	  <a href="temp_insert.php?prod_id=<?php echo $p_id; ?>">add to cart</a>
     </tr>
	 </table>
