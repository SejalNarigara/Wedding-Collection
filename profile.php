...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<li class="activate"><a href="view-order.php">view orders</a></li>
...
<!--			<li><a href="blog.php">BLOG</a></li>
 ...
 -->
	...
	<div class="grid_12"><!-- start main -->
      <div class="container">
</div>
</div>
</div>
<div class="main_btm1"><!-- start main_btm -->
<h3 class="style pull-left">&nbsp;</h3>
<div class="main_bg">
  <div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">PROFILE</h3>
...
include "connection.php";
	$id = $_SESSION['cust_id'];
	$data = "SELECT * FROM registation WHERE email='$id'";
	  $res=mysql_query($data);
		  $row=mysql_fetch_array($res);
		//echo $row;
	//return;
	echo "<table style='margin-top:40px;font-size:20px;' align='center' width='300px;'>";
	echo "<tr>
	      <td> First Name: </td>
		  <td>".$row['fname']."</td>
		  </tr>";
	...
	echo '<center><td><tr>
						  <td><center><a href="update.php"><input type="submit" value="update" name="btnupdate"></a></center></td><';
	?>
